...
public:
  ...
  virtual void CreateDefaultRepresentation() VTKDRCFILTERS_OVERRIDE;
...
protected:
  vtkFrameWidget();
  virtual ~vtkFrameWidget() VTKDRCFILTERS_OVERRIDE;
...
private:
  vtkFrameWidget(const vtkFrameWidget&) VTKDRCFILTERS_DELETE_FUNCTION;
  void operator=(const vtkFrameWidget&) VTKDRCFILTERS_DELETE_FUNCTION;
};
