...
if (testNumber==0): 
    polyData = io.readPolyData('/home/mfallon/Desktop/rgbd_data/valve_sparse.pcd')
    vis.showPolyData(polyData, 'depth point cloud', visible=False, colorByName='rgb_colors')
    ...
    polyData = io.readPolyData('/home/mfallon/Desktop/rgbd_data/valve_dense.pcd')
    vis.showPolyData(polyData, 'depth point cloud', visible=False, colorByName='rgb_colors')
    polyData = segmentationroutines.sparsifyStereoCloud( polyData )
    ...
    polyData = io.readPolyData('/home/mfallon/Desktop/rgbd_data/table_sparse.vtp')
    vis.showPolyData(polyData, 'depth point cloud', visible=False, colorByName='rgb_colors')
    polyData = segmentationroutines.sparsifyStereoCloud( polyData )
